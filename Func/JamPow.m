...
JamPow_values = 20:2:30; % P_dBm从10到30，间隔2dB
num_JamPow_values = length(JamPow_values);

RatesPerMA = zeros(num_simulations, num_JamPow_values, 11);
RatesMA = zeros(num_simulations, num_JamPow_values, 11);
RatesRecMA = zeros(num_simulations, num_JamPow_values, 11);
RatesTransMA = zeros(num_simulations, num_JamPow_values, 11);
RatesFPA = zeros(num_simulations, num_JamPow_values, 11);
