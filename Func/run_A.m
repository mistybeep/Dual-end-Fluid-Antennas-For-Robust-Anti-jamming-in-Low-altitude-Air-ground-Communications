...
RatesPerMA = zeros(num_simulations, num_norm_A_values, 11);
RatesMA = zeros(num_simulations, num_norm_A_values, 11);
RatesRecMA = zeros(num_simulations, num_norm_A_values, 11);
RatesTransMA = zeros(num_simulations, num_norm_A_values, 11);
RatesFPA = zeros(num_simulations, num_norm_A_values, 11);
